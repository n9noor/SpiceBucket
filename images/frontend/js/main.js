...
(function($) {
    ...
    $("body").on("click", ".add-to-cart", function(){
        ...
        if($.inArray(parseInt(p_id), cart) == -1){
            ...
            qty=1;               
            var p_html = '<li data-pid="product-' + p_id + '" data-qty="1" data-price="'+ (p_price.replace(/<[^>]*>?/gm)) +'">'+
        ...
        $('li[data-pid^="product-"]').each(function(){
            subtotalprice += (parseFloat($(this).attr('data-price')) * parseFloat($(this).attr('data-qty')));
        });
        gstprice = subtotalprice * 0.18;
        totalprice = subtotalprice + gstprice;
        $('#sub-price').html(subtotalprice.toFixed(2));
        $('#gst-price').html(gstprice.toFixed(2));
        $('#total-price').html(totalprice.toFixed(2));
        $.ajax({method:"GET", url:"mycart", data:{product_id:p_id, quantity:qty}});
    });
    ...
    (function() {
        ...
        $("body").on("click", ".ec-pro-content .remove", function(){
            ...
            var gstprice = subtotalprice * 0.18;
            var totalprice = subtotalprice + gstprice;
            $('#sub-price').html(subtotalprice.toFixed(2));
            $('#gst-price').html(gstprice.toFixed(2));
            $('#total-price').html(totalprice.toFixed(2));
