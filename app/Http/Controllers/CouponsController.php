        ...
        if (count($customerfilter) > 0) {
            if (in_array(Session::get('customer-loggedin-id'), $customerfilter)) {
                if ($subtotal < $coupons->minimum_cart_amount) {
                    return response()->json(['status' => false, 'discount' => $discount,'message' => 'Add <i class="fa fa-rupee-sign"></i> ' . ($coupons->minimum_cart_amount - $subtotal) . ' to avail this coupon.'], 200);
                }
            ...
            if ($subtotalproductwise < $coupons->minimum_cart_amount) {
                return response()->json(['status' => false, 'discount' => $discount,'message' => 'Add <i class="fa fa-rupee-sign"></i> ' . ($coupons->minimum_cart_amount - $subtotalproductwise) . ' to avail this coupon.'], 200);
            }
            ...
            if ($subtotalvendorwise < $coupons->minimum_cart_amount) {
                return response()->json(['status' => false, 'discount' => $discount,'message' => 'Add <i class="fa fa-rupee-sign"></i> ' . ($coupons->minimum_cart_amount - $subtotalvendorwise) . ' to avail this coupon.'], 200);
            }
            ...
            if ($subtotalcategorywise < $coupons->minimum_cart_amount) {
                return response()->json(['status' => false,'discount' => $discount, 'message' => 'Add <i class="fa fa-rupee-sign"></i> ' . ($coupons->minimum_cart_amount - $subtotalcategorywise) . ' to avail this coupon.'], 200);
            }
