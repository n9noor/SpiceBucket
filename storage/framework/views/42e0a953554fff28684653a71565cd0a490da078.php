        ...
        <div class="table-responsive">
            <table id="document-type-table" class="table table-stripped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a onclick="$('#document_type_id').val(<?php echo e($type->id); ?>);$('#document_type').val('<?php echo e($type->type); ?>');" data-bs-toggle="modal" data-bs-target="#add-document-type-modal" class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-primary" href="javascript:void(0)"><i class="btn-icon-wrapper fa fa-edit"></i></a>
                        ...
                        <td><input data-column="is_active" data-type="document_type" data-id="<?php echo e($type->id); ?>" type="checkbox" <?php echo e($type->is_active == true ? " checked='checked'" : ""); ?> data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="success" data-offstyle="danger"></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("wms.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/spicebucket/resources/views/wms/documents.blade.php ENDPATH**/ ?>