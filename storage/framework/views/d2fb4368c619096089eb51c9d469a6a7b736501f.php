...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/main.css?v=<?php echo e(rand()); ?>" />
...
<hr>
  ...
  crossorigin="anonymous"></script>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js" integrity="sha512-Eak/29OTpb36LLo2r47IpVzPBLXnAMPAVypbSZiZ4Qkf8p/7S/XRG5xp7OKWPPYfJT6metI+IORkR5G8F900+g==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="/assets/js/main.js?v=<?php echo e(rand()); ?>"></script>

    <script src="/assets/js/shop.js?v=5.6"></script>

    <script src="/assets/js/cart.js?v=<?php echo e(rand()); ?>"></script>
