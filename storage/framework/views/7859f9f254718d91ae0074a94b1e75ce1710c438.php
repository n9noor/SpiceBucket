...
<div class="page-header breadcrumb-wrap">
	<div class="container">
		<div class="breadcrumb">
			...
			<span></span> <a href="/blog">Blog</a> <span></span> <?php echo e($blog->title); ?>
					...
					<div class="col-lg-9">
						<div class="single-page pt-50 pr-30">
									...
									<div class="col-xl-10 col-lg-12">
										...
										<div class="single-header-meta">
											<div class="entry-meta meta-1 font-xs mt-15 mb-15">
												...
												<span class="post-by">By <a href="#"><?php echo e($blog->created_by); ?></a></span>
												<span class="post-on has-dot"><?php echo e(date('d F Y H:i A', strtotime($blog->created_at))); ?></span>
							...
							<figure class="single-thumbnail">
								<img src="<?php echo e(!is_null($blog->featured_image) ? (env('APP_ENV') == 'production' ? url('/public/images/blogs/' . $blog->featured_image) : url('/images/blogs/' . $blog->featured_image)) : url('/assets/imgs/no-image-placeholder.png')); ?>" alt="" />
							</figure>
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/spicebucket/resources/views/blogs/frontend-detail.blade.php ENDPATH**/ ?>