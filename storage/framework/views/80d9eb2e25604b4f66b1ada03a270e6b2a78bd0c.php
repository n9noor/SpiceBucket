        ...
        <div class="row">
            ...
            <div class="col-lg-8 mb-10">
                ...
                <div class="d-flex justify-content-between bg-light-msg">
                    ...
                    <h6 class="text-body">There are <span class="text-brand"><?php echo e(count(array_keys(Session::get('customer-cart')))); ?></span> products in your cart, Please Proceed checkout this page with these sellers:</h6>
                                ...
                                <div class="col-md-12">
                                    <div class="check-container">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1 col-xs-3 pr0">
                                                        <div class="seller-logo-check">
                                                            <img src="<?php echo e(env('APP_ENV') == 'production' ? url('/public/images/vendors/' . $cart['vendor_image']) : url('/images/vendors/' . $cart['vendor_image'])); ?>" alt="<?php echo e(!is_null($cart['vendor_alias']) && !empty($cart['vendor_alias']) ? $cart['vendor_alias'] : $store_name); ?>" class="img-fluid rounded" width="30">
                                                        </div>
                                                    </div>

                                                    <div class="col-md-4 col-xs-4 pr0">
                                                        <div class="seller-name-check">
                                                            <span class="font-weight-bold"> <?php echo e(!is_null($cart['vendor_alias']) && !empty($cart['vendor_alias']) ? $cart['vendor_alias'] : $store_name); ?></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row cart-item">
                                                    ...
                                                    <div class="col-2">
                                                        ...
                                                        <div class="checkout-product-img-wrapper">
                                                            ...
                                                            <img class="item-thumb img-thumbnail img-rounded" src="<?php echo e(env('APP_ENV') == 'production' ? url('/public/images/products/' . $product['image']) : url('/images/products/' . $product['image'])); ?>" alt="<?php echo e($product['title']); ?>">

                                                            <span class="checkout-quantity"><?php echo e($product['quantity']); ?></span>
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <p class="mb-0"><?php echo e($product['title']); ?></p>

                                                        <p class="mb-0">

                                                            <small><?php echo e($product['variant']); ?></small>
                                                    ...
                                                    <div class="col-4 text-end">
                                                        ...
                                                        <p><i class="fa fa-rupee-sign"></i> <?php echo e($product['price']); ?>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="address-sec">
                                                        ...
                                                        <div class='form-group'>
                                                            ...
                                                            <select class="form-control" id="address-billing-<?php echo e($cart['storeid']); ?>" name="address[billing][<?php echo e($cart['storeid']); ?>]">

                                                                <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                                <option data-format="<p class='mb-0'><small><?php echo e($address->firstname); ?> <?php echo e($address->lastname); ?> </br><?php echo e($address->address_line_1); ?> <?php echo e($address->address_line_2); ?> <?php echo e($address->address_line_3); ?> <?php echo e($address->city); ?>, <?php echo e($address->state); ?>-<?php echo e($address->pincode); ?>, <?php echo e($address->country); ?></p>" value='<?php echo e($address->id); ?>'>

                                                                    <?php echo e(ucfirst($address->address_type)); ?>
                                                        ...
                                                        <div id='address-billing-<?php echo e($cart['storeid']); ?>-fulladdress'>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="address-sec">
                                                        ...
                                                        <div class='form-group'>
                                                            ...
                                                            <select data-vendor-shipping-pincode="<?php echo e($cart['vendor_shipping_pincode']); ?>" class="form-control" id="address-shipping-<?php echo e($cart['storeid']); ?>" name="address[shipping][<?php echo e($cart['storeid']); ?>]">

                                                                <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                                <option data-pincode="<?php echo e($address->pincode); ?>" data-format="<p class='mb-0'><small><?php echo e($address->firstname); ?> <?php echo e($address->lastname); ?> <br /><?php echo e($address->address_line_1); ?> <?php echo e($address->address_line_2); ?> <?php echo e($address->address_line_3); ?> <?php echo e($address->city); ?>, <?php echo e($address->state); ?>-<?php echo e($address->pincode); ?>, <?php echo e($address->country); ?></small></p>" value='<?php echo e($address->id); ?>'>
                                                        ...
                                                        <div id='address-shipping-<?php echo e($cart['storeid']); ?>-fulladdress'>
                                        ...
                                        $vendortotalshippingprice = 0;
                                                ...
                                                array_push($shippingforbrand, array('shippingprice' => $vendortotalshippingprice, 'baseshippingprice' => $baseshippingprice, 'gstshippingprice' => $gstshippingprice)); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 text-end">
                                                            ...
                                                            <p class="price-text sub-total-text text-end"><i class="fa fa-rupee-sign"></i>
                                                                ...
                                                                <?php echo e(number_format($vendortotalsubprice, 2)); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 text-end">
                                                            ...
                                                            <p class="price-text tax-price-text"><i class="fa fa-rupee-sign"></i>
                                                                ...
                                                                <?php echo e(number_format(($vendortotalgstprice + $gstshippingprice), 2)); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 text-end">
                                                            ...
                                                            <p class="price-text tax-price-text"><i class="fa fa-rupee-sign"></i>
                                                                ...
                                                                <?php echo e(number_format($baseshippingprice, 2)); ?>


                                                            </p>

                                                            <input type="hidden" name="delivery_fee[<?php echo e($cart['storeid']); ?>]" id="delivery-fee-<?php echo e($cart['storeid']); ?>" value="<?php echo e($vendortotalshippingprice); ?>" />
												...
												<!-------------- END ----------->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 float-end">
                                                            ...
                                                            <p class="total-text raw-total-text mb-0 vendor-amount-text" id="walletaddon_406" data-price="<?php echo e($vendortotalprice + $vendortotalshippingprice + $total); ?>"><i class="fa fa-rupee-sign"></i>

                                                                <span><?php echo e(number_format(($vendortotalprice + $vendortotalshippingprice + $total), 2)); ?></span>
                            ...
                            <div class="coupon-block-list">
                                ...
                                <ul>
                                    ...
                                    <li class="coupon-list" title="Apply">
                                        ...
                                        <div class="co-code"><span class="promo"><?php echo e($coupon->coupon_code); ?></span><a class="apply-btn" data-coupon="<?php echo e($coupon->coupon_code); ?>" href="javascript:void(0);">Apply</a></div>

                                        <div class="coupon-detail"> <a href="javascript:void(0)" data-description='<?php echo $coupon->coupon_description; ?>'> Coupon Detail</a></div>

                                        <!--<p class="expire">Expires: <?php echo e(date('M d, Y', strtotime($coupon->end_datetime))); ?></p>-->

                                    </li>

                                    <!--<li data-coupon="<?php echo e($coupon->coupon_code); ?>">

                                    <p><?php echo e($coupon->title); ?> Use Promo Code: <a href="javascript:void(0);"><span title="Apply" class="promo"><?php echo e($coupon->coupon_code); ?></span></a></p>
                        ...
                        <div class="mt-2 p-2 chek-single-cal">
                            ...
                            <div class="row horizontal-row">
                                ...
                                <div class="col-4 pl0">
                                    ...
                                    <p class="price-text sub-total-text" id="cartsubtotalprice" data-price="<?php echo e($carttotalsubprice); ?>"><i class="fa fa-rupee-sign"></i>

                                        <?php echo e(number_format($carttotalsubprice, 2)); ?>


                                        <input type="hidden" id="cartTotlaPriceForPoints" name="cartTotlaPriceForPoints" value="<?php echo e(number_format($carttotalsubprice, 2)); ?>" />
                            ...
                            <div class="row horizontal-row">
                                ...
                                <div class="col-4 pl0">
                                    ...
                                    <p class="price-text shipping-price-text"><i class="fa fa-rupee-sign"></i> <?php echo e(number_format(array_sum(array_column($shippingforbrand, 'baseshippingprice')), 2)); ?></p>
                            ...
                            <div class="row horizontal-row">
                                ...
                                <div class="col-4 pl0">
                                    ...
                                    <p class="price-text tax-price-text"><i class="fa fa-rupee-sign"></i>
                                        ...
                                        <?php echo e(number_format($carttotalgstprice + array_sum(array_column($shippingforbrand, 'gstshippingprice')), 2)); ?>
                            ...
                            <div class="row horizontal-row">
                                ...
                                <div class="col-4 float-end pl0">
                                    ...
                                    <p class="total-text raw-total-text cart-total-text" id="walletaddon" data-price="<?php echo e($carttotalprice + $total +  array_sum(array_column($shippingforbrand, 'shippingprice'))); ?>"><i class="fa fa-rupee-sign"></i> <span>
													<!--<div id="walletaddon"></div>-->
													<?php echo e($carttotalprice + $total + array_sum(array_column($shippingforbrand, 'shippingprice'))); ?>

												</span> </p>

                                    <input type="hidden" name="totalcartamout" id="totalcartamout" value="<?php echo e($carttotalprice + array_sum(array_column($shippingforbrand, 'shippingprice'))); ?>" />
                                    ...
                                    <input type="hidden" name="total_delivery_fee" id="total_delivery_fee" value="<?php echo e(array_sum(array_column($shippingforbrand, 'shippingprice'))); ?>" />
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var options = {
                            ...
                            image: "<?php echo e(asset('images/logo-color.png')); ?>",
                            ...
                            prefill: {
                                ...
                                name: "<?php echo e(Session::get('customer-loggedin-name')); ?>",

                                email: "<?php echo e(Session::get('customer-loggedin-email')); ?>",

                                contact: "<?php echo e(Session::get('customer-loggedin-phone')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/spicebucket/resources/views/checkout.blade.php ENDPATH**/ ?>