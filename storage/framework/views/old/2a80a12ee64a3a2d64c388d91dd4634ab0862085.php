        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="table-responsive shopping-summery">
                    ...
                    <?php $subprice=$gstprice=$totalprice=0; $shippingbasepriceforBrand = array(); $netpriceforBrand = array(); ?>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td class="free-delivery-note remain" style="padding-left: 10px;" colspan="7" id="remaining-amount-for-free-delievery-<?php echo e($cart['storeid']); ?>">
                                            ...
                                            achievedAmount: Rs. <?php echo e($achievedAmount); ?>

                                            remainingprogressbar: Rs. <?php echo e(499 - $achievedAmount); ?>
                                                ...
                                                <div class="progress">
                                                    ...
                                                    aria-valuemin="0" aria-valuemax="100" style="width:<?php echo e(100 - $achievedPercent); ?>%" style="color:#333333;">
                                                        Rs. <?php echo e(499 - $achievedAmount); ?>

                                                    </div>
                                                </div>
                                            </div>
                                            <marquee width="100%" direction="left" height="auto">
                                                    <small>Note: Add <i class="fa fa-rupee-sign"></i> <?php echo e($remainingAmount); ?> More For Free Shipping</small>
                                            </marquee>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="" class="cart_total_amount">
                                        ...
                                        <h4 class="text-brand text-end"><i class="fa fa-rupee-sign"></i> <span id="total-cart-price"><?php echo e(number_format(($totalprice + array_sum(array_column($shippingforbrand, 'shippingprice'))),2)); ?></span> </h4>
