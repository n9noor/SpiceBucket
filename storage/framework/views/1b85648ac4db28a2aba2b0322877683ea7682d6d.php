    ...
    <div class="container">
        <!--<section class="mb-60">
            <div class="ck-content">
				...
				<!--	<iframe width="100%" height="500" src="<?php echo e(array_key_exists('googlemaplink', $contact) && strlen($contact['googlemaplink']) > 0 ? $contact['googlemaplink'] : 'https://maps.google.com/maps?q=502 New Street, Brighton VIC, Australia%20&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed'); ?>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
        ...
        <!--</div>
                ...
                <div class="mt-50 pb-50">
                    <div class="row">
                        <?php $count=array_key_exists('officename', $contact) ? count($contact['officename']) : 0; ?>
                        <?php for($i=0; $i<($count); $i++): ?> <div class="col-md-4 mb-4 mb-md-0">
                            <h4 class="mb-15 text-muted"><?php echo e(array_key_exists('officename', $contact) && strlen($contact['officename'][$i]) > 0 ? $contact['officename'][$i] : 'Head Office'); ?></h4><?php echo e(array_key_exists('officeaddress', $contact) && strlen($contact['officeaddress'][$i]) > 0 ? $contact['officeaddress'][$i] : '205 North Michigan Avenue, Suite 810, Chicago, 60601, USA'); ?><br><abbr title="Phone">Phone: </abbr><?php echo e(array_key_exists('officephone', $contact) && strlen($contact['officephone'][$i]) > 0 ? $contact['officephone'][$i] : '(+01) 234 567'); ?><br><abbr title="Email">Email: </abbr><?php echo e(array_key_exists('officeemail', $contact) && strlen($contact['officeemail'][$i]) > 0 ? $contact['officeemail'][$i] : 'office@botble.com'); ?><br><a href="<?php echo e(array_key_exists('officemapurl', $contact) && strlen($contact['officemapurl'][$i]) > 0 ? $contact['officemapurl'][$i] : 'https://maps.google.com/?q=205+North+Michigan+Avenue%2C+Suite+810%2C+Chicago%2C+60601%2C+USA'); ?>" class="btn btn-outline btn-sm btn-brand-outline font-weight-bold text-brand bg-white text-hover-white mt-20 border-radius-5 btn-shadow-brand hover-up"><i class="fa fa-map text-muted mr-15"></i>View map</a>
                    </div>
                    <?php endfor; ?>
                </div>
            </div>
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/spicebucket/resources/views/contact.blade.php ENDPATH**/ ?>