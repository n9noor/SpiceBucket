                                        ...
                                        <form action="/login-process" method="post">
                                            ...
                                            <div id='sign-in' class='login-setup-section'>
												...
												<div class="form-group login-label">
													<input type="text" name="email" class="form-control input-edit" placeholder='Enter mobile number/Email ID' id="email" value="<?php echo e(old('email')); ?>">
												</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/spicebucket/resources/views/auth/login.blade.php ENDPATH**/ ?>