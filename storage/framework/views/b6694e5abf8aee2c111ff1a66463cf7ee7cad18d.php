...
<head>
    ...
    <link href="<?php echo e(asset('backend/styles/css/base.css?v=1.0')); ?>" rel="stylesheet">
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div class="logo-srcs"><img src="<?php echo e(asset('images/logo-color.png')); ?>" style="width:90px; "></div>
                    ...
                    <div class="header-dots">
                        <div class="dropdown">
                                <?php if(session('vendor-logged-in') == true): ?>
                                    <a <?php echo e(Request::url() == env('APP_URL').'/sellers/notification' ? "class=active" : ""); ?> 
                                        title="Notifications" 
                                        href="/sellers/notification">

                                       <span class="notifi_count"><?php echo e(session('notificationCount')); ?></span>
                                        <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                                            <span class="icon-wrapper-bg bg-danger"></span>
                                            <i class="icon text-danger icon-anim-pulse ion-android-notifications"></i>
                                            <span class="badge badge-dot badge-dot-sm bg-danger notifi_count">Notifications <?php echo e(session('notificationCount')); ?></span>
                                        </span>
                                    </a>
                                <?php else: ?>
                                    <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                                                                            ...
                                                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/1.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/2.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/3.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/4.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/5.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/9.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/7.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon">
                                                                                        <img src="<?php echo e(asset('backend/images/avatars/8.jpg')); ?>" alt="">
                                                                                    </div>
                                                                                </div>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="<?php echo e(asset('backend/images/avatars/1.jpg')); ?>" alt="">
                                                    ...
                                                    <div class="menu-header-content text-start">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading"><?php echo e(session('vendor-logged-in') == true ? session('vendor-loggedin-name') : session('admin-loggedin-name')); ?></div>
                                                                    <div class="widget-subheading opacity-8"></div>
                                                                </div>
                                                                <div class="widget-content-right me-2">
                                                                    <button class="btn-pill btn-shadow btn-shine btn btn-focus" onclick="window.location.href='/<?php echo e(session("vendor-logged-in") == true ? "sellers" : "administrator"); ?>/logout';">Logout</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
-->
                                                        <li class="nav-item">
                                                            <a href="<?php echo e(session('vendor-logged-in') == true ? "/sellers/my-profile" : "javascript:void(0)"); ?>" class="nav-link">Profile</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
...
-->
                                                    <div class="col-sm-6">
                                                        <a class="btn-icon-vertical btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-danger" href="/sellers/ticket"">
                                                            <i class="pe-7s-ticket icon-gradient bg-love-kiss btn-icon-wrapper mb-2"></i>
															<?php if(Session::get('vendor-logged-in') == true): ?>
                                                            <b>Support Tickets</b>
															<?php endif; ?>
													...
													<?php if(Session::get('admin-logged-in') == true): ?>
                                                    <div class="col-sm-6">
                                                        <a class="btn-icon-vertical btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-danger" href="/ticket"">
                                                            <i class="pe-7s-ticket icon-gradient bg-love-kiss btn-icon-wrapper mb-2"></i>
                                                            <b>Tickets</b>
                                                        </a>
                                                    </div>
...
-->
                                ...
                                <div class="widget-content-left  ms-3 header-user-info">
                                    <div class="widget-heading"><?php echo e(session('vendor-logged-in') == true ? session('vendor-loggedin-name') : session('admin-loggedin-name')); ?></div>
                                    <div class="widget-subheading"><?php echo e(session('vendor-logged-in') == true ? session('vendor-loggedin-shopname') : session('admin-loggedin-rolename')); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- madhav  <div class="ui-theme-settings">
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/sellers/dashboard' ? "class=active" : ""); ?> href="/sellers/dashboard">
                                    <i class="metismenu-icon pe-7s-rocket"></i>
                                    Dashboard
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/products/categories' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/products/categories" : "javascript:void(0)"); ?>">
                                    <i class="metismenu-icon pe-7s-umbrella"></i>
                                    Category
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/products/list' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/products/list" : "javascript:void(0)"); ?>">
                                    <i class="metismenu-icon pe-7s-ball"></i>
                                    Products
                                </a>
                            </li>
                            <li>
                                <a title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="javascript:void(0)">
                                ...
                                <ul>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/report/order' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/report/order" : "javascript:void(0)"); ?>">
                                            <i class="metismenu-icon"></i>
                                            Order Details
                                        </a>
                                    </li>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/report/invoice-tax' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/report/invoice-tax" : "javascript:void(0)"); ?>">
                                            <i class="metismenu-icon"></i>
                                            Invoice Tax Details
                                        </a>
                                    </li>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/report/sale-summary' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/report/sale-summary" : "javascript:void(0)"); ?>">
                                            <i class="metismenu-icon"></i>
                                            Sale Summary
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/sellers/orders' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/sellers/orders" : "javascript:void(0)"); ?>">
                                    <i class="metismenu-icon pe-7s-photo-gallery"></i>
                                    Order
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <!--<li>
                                        <a title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "javascript:void(0)"); ?>" data-bs-toggle="modal" data-bs-target="#coming-soon-modal">
                                            <i class="metismenu-icon"></i>
                                            Store Policy
                                        </a>
                                    </li>-->
									<li>
                                        <a href="http://spicebucket.net/store-policy" target="_blank">
                                            <i class="metismenu-icon"></i>
                                            Store Policy
                                        </a>
                                    </li>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/sellers/settings' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/sellers/settings" : "javascript:void(0)"); ?>">
                                            <i class="metismenu-icon"></i>
                                            Global Setting
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/sellers/users' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/sellers/users" : "javascript:void(0)"); ?>">
                                    <i class="metismenu-icon pe-7s-photo-gallery"></i>
                                    Users
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/sellers/roles' ? "class=active" : ""); ?> title="<?php echo e(session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"); ?>" href="<?php echo e(session('vendor-loggedin-approved') == 1 ? "/sellers/roles" : "javascript:void(0)"); ?>">
                                    <i class="metismenu-icon pe-7s-photo-gallery"></i>
                                    Roles
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/sellers/ticket' ? "class=active" : ""); ?> href="/sellers/ticket">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Tickets
                                </a>
                            </li>
                        </ul>
                        <?php elseif(session('admin-logged-in') == true): ?>
                        <ul class="vertical-nav-menu">
                            <li class="app-sidebar__heading">Menu</li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/administrator' ? "class=active'" : ""); ?> href="/administrator">
                                    <i class="metismenu-icon pe-7s-rocket"></i>
                                    Dashboard
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/administrator/vendor-document-type' ? "class='active'" : ""); ?> href="/administrator/vendor-document-type">
                                            <i class="metismenu-icon"></i>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/administrator/users' ? "class=active" : ""); ?> href="/administrator/users">
                                            <i class="metismenu-icon"></i>
                                            List
                                        </a>
                                    </li>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/administrator/roles' ? "class=active" : ""); ?> href="/administrator/roles">
                                            <i class="metismenu-icon"></i>
                                            Departments
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/sellers/list' ? "class=active" : ""); ?> href="/sellers/list">
                                    <i class="metismenu-icon pe-7s-cloud-upload"></i>
                                    Sellers
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/products/categories' ? "class=active" : ""); ?> href="/products/categories">
                                    <i class="metismenu-icon pe-7s-cloud-upload"></i>
                                    Categories
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/products/list' ? "class=active" : ""); ?> href="/products/list">
                                    <i class="metismenu-icon pe-7s-cloud-upload"></i>
                                    Product
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/report/order' ? "class=active" : ""); ?> href="/report/order">
                                            <i class="metismenu-icon"></i>
                                            Order Details
                                        </a>
                                    </li>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/report/invoice-tax' ? "class=active" : ""); ?> href="/report/invoice-tax">
                                            <i class="metismenu-icon"></i>
                                            Invoice Tax Details
                                        </a>
                                    </li>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/report/sale-summary' ? "class=active" : ""); ?> href="/report/sale-summary">
                                            <i class="metismenu-icon"></i>
                                            Sale Summary
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a href="/sellers/orders">
                                    <i class="metismenu-icon pe-7s-cart"></i>
                                    Order
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/administrator/customers' ? "class=active" : ""); ?> href="/administrator/customers">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Customers
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/offer/list' ? "class=active" : ""); ?> href="/offer/list">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Offers
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/administrator/coupons' ? "class=active" : ""); ?> href="/administrator/coupons">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Discount Coupons
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/administrator/static-page' ? "class=active" : ""); ?> href="/administrator/static-page">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Static Page
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/administrator/faq' ? "class=active" : ""); ?> href="/administrator/faq">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    FAQ
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/ticket' ? "class=active" : ""); ?> href="/ticket">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Tickets
                                </a>
                            </li>
                            ...
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/administrator/mail' ? "class=active" : ""); ?> href="/administrator/mail">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Mail
                                </a>
                            </li>
                            <li>
                                <a <?php echo e(Request::url() == env('APP_URL').'/administrator/message' ? "class=active" : ""); ?> href="/administrator/message">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Message 
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/administrator/notification/sellers' ? "class=active" : ""); ?> 
                                            href="/administrator/notification/sellers">
                                            <i class="metismenu-icon"></i>
                                            Sellers
                                        </a>
                                    </li>
                                    <li>
                                        <a <?php echo e(Request::url() == env('APP_URL').'/administrator/notification/customers' ? "class=active" : ""); ?> 
                                            href="/administrator/notification/customers">
                                            <i class="metismenu-icon"></i>
                                            Customers
                                        </a>
                                    </li>
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left me-3">
                                            <div class="widget-content-left">
                                                <img width="42" class="rounded" src="<?php echo e(asset('backend/images/avatars/1.jpg')); ?>" alt="" />
                                            </div>
                                        </div>
                                        <div class="widget-content-left">
                                    ...
                                    <div class="vertical-timeline-element-content bounce-in">
                                        <h4 class="timeline-title">
                                            ...
                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                ...
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="<?php echo e(asset('backend/images/avatars/6.jpg')); ?>" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
    ...
    <input type="hidden" name="defaultcsrftoken" id="defaultcsrftoken" value="<?php echo e(csrf_token()); ?>">
    <!-- plugin dependencies -->
    <script type="text/javascript" src="<?php echo e(asset('backend/vendors/jquery/dist/jquery.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('backend/vendors/bootstrap/dist/js/bootstrap.bundle.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('backend/vendors/metismenu/dist/metisMenu.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('backend/vendors/apexcharts/dist/apexcharts.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('backend/vendors/toastr/build/toastr.min.js')); ?>"></script>
    <?php echo $__env->yieldPushContent('externalJavascripts'); ?>
    <!-- custome.js -->
    <script src="/assets/alertifyjs/alertify.min.js"></script>
    <script type="text/javascript" src="<?php echo e(asset('backend/js/charts/apex-charts.js')); ?>"></script>
...
</html><?php /**PATH /var/www/spicebucket/resources/views/wms/layout.blade.php ENDPATH**/ ?>