                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-12">
                            ...
                            <p class="alert alert-success"><?php echo e(Session::get('subsuccess')); ?></p>
                            <?php endif; ?>
                            <div class="tab-content account dashboard-content">
                                <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="mb-0">Hello, <?php echo e(Session::get('customer-loggedin-name')); ?></h3>
                                        </div>
                                        <div class="card-body">
                                            <p>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody style="text-align: center;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td nowrap="" ><?php echo e(date('d/M/Y h:i A', strtotime($order->created_at))); ?>

                                                            </td>
                                                            <td nowrap=""><?php echo e(strtolower($order->order_status) == 'cancel' ? 'Cancelled' : ucwords($order->order_status)); ?></td>
                                                            <td nowrap=""><i class="fa fa-rupee-sign"></i> <?php echo e($order->total_amount); ?></td>
                                                            <td nowrap=""><a href="javascript:void(0)" onclick="getInvoiceDetail(<?php echo e($order->id); ?>)" class="btn-small d-block">View</a>
                                                            </td>
                                                        </tr>
                                ...
                                <div class="tab-pane fade" id="address" role="tabpanel" aria-labelledby="address-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 dashboard-address-item  is-address-default ">
                                            <div class="card h-100 mb-3 mb-lg-0 mb-2">
                                                <div class="card-header">
                                                    <h5 class="mb-0"><?php echo e($address->firstname); ?> <?php echo e($address->lastname); ?>

                                                        <small class="badge address-dashboard"><?php echo e(strtoupper($address->address_type)); ?></small>
                                                    </h5>
                                                    <?php if($address->is_default == 1): ?>
                                                    <small class="badge default-dashboard">DEFAULT</small>
                                                    <?php else: ?>
                                                    <small style="cursor: pointer;" data-id="<?php echo e($address->id); ?>" class="badge  address-mark-as-default">MARK DEFAULT</small>
                                                    <?php endif; ?>
                                                                                                </div>
                                                <div class="card-body">
                                                    <address>
                                                        ...
                                                        <?php echo e($address->address_line_3); ?>

                                                    </address>
                                                    <p>City : <?php echo e($address->city); ?></p>
                                                    <p>State : <?php echo e($address->state); ?></p>
                                                    <p>Pin Code : <?php echo e($address->pincode); ?></p>
                                                    <p>Country : <?php echo e($address->country); ?></p>
                                                </div>
                                                <div class="card-footer border-top-0">
                                                    <div class="row">
                                                        <div class="col-auto me-auto"><a href="javascript:void(0)" onclick="editAddress(<?php echo e($address->id); ?>)" class="edit-address-info"><i class="fas fa-edit"></i> Edit</a></div>
                                                        <div class="col-auto"><a href="javascript:void(0)" onclick="removeAddress(<?php echo e($address->id); ?>)" class="text-danger btn-trigger-delete-address removeAddress"><i class="fas fa-trash-alt"></i> Remove</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <form action="javascript:void(0)" name="enq">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="" class="form-control" name="first_name" id="first_name" type="text" value="<?php echo e($firstName); ?>" />
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Last Name <span class="required">*</span></label>
                                                        <input required="" class="form-control" name="last_name" id="last_name" value="<?php echo e($lastName); ?>" />
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label>Phone<span class="required">*</span></label>
                                                        <input required="" class="form-control" name="phone" id="phone" type="text" value="<?php echo e($customer->phone); ?>" />
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label>Email Address <span class="required">*</span></label>
                                                        <input required="" class="form-control" name="email" id="email" type="email" value="<?php echo e($customer->emailid); ?>" />
                                                    </div>
                                                    <div class="col-md-12">
...
<script>
    ...
    var myConfig = {
        ...
        scaleR: {
            ...
            labels: <?php echo json_encode($rewards, 15, 512) ?>,
            ring: {
                size: 50,
                rules: [{
                        rule: '%v >= 0 ',
        ...
        series: [{
            values: [<?php echo e($rewardhistory); ?>], 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/spicebucket/resources/views/auth/dashboard.blade.php ENDPATH**/ ?>