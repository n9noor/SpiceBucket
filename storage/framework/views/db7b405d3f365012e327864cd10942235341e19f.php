...
<div class="app-page-title">
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <button type="button" onclick="window.location.href='/ticket/add'" title="Add Offer" class="btn-icon btn-shadow me-3 btn btn-dark">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("wms.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/spicebucket/resources/views/ticket/list.blade.php ENDPATH**/ ?>