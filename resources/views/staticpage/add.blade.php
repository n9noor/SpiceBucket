...
<div class="main-card mb-3 card">
    <div class="card-body">
        <form action="/administrator/save-static-page" method="post" class="form-horizontal">
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="position-relative mb-3">
                        ...
                        <input type="text" class="form-control" name="slug" id="slug" placeholder="Enter URL for the page" />
                        @error('slug')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="position-relative mb-3">
                        ...
                        <textarea class="form-control" name="description" id="description" placeholder="Enter Description for Page"></textarea>
                    </div>
                </div>
            </div>
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative mb-3">
                            ...
                            <input type="seo_keywords" class="form-control" name="seo_keywords" id="seo_keywords" placeholder="Enter  SEO Keywords" />
                            @error('seo_keywords')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="position-relative mb-3">
                            ...
                            <textarea name="seo_description" class="form-control" id="seo_description" placeholder="Enter SEO Description for Page"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="position-relative mb-3">
                            ...
                            <textarea name="header_part" class="form-control" id="header_part" placeholder="Script for HEAD Section"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative mb-3">
                            <label for="footer_part" class="form-label">Script for BODY Section</label>
                            <textarea name="footer_part" class="form-control" id="footer_part" placeholder="Script for BODY Section"></textarea>
                        </div>
                    </div>
                </div>
            </fieldset>
