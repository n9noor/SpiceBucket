            ...
            <div style="text-align:center;background-color:#ffffff;margin-top:1.0em">
                <table cellpadding="5" cellspacing="0" border="0" width="100%" style="font-family:Arial,Helvetica,sans-serif;background-color:#ffffff;color:#666666;border-bottom:solid 4px #e2e2e2;font-size:12px;text-align:left">
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align:center;padding-bottom:10px;color:#8b8c83;border-bottom:solid 1px #e2e2e2;font-size:18px">Order {{$vendorDetail['orderID']}} is cancelled</td>
                        </tr>
                        <tr>
                            <td style="font-weight:bold;padding-top:10px">Dear {{Session::get('customer-loggedin-name')}}</td>
                        </tr>
                        <tr>
                            <td>As per your request, your order {{$vendorDetail['orderID']}}  has been cancelled. If you have made payment for this order, the amount will be refunded to you in the same account from which you had made the payment. In case you had made payment in cash, we request you to share the bank account details in which we can make the payment including the IFSC code of the branch.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Below are your order details.</td>
                        </tr>
                        <tr>
                            <td>
                                @php
                                ...
                                <table cellpadding="5" cellspacing="0" border="1" width="100%" style="border:solid 1px #f2f2f2;border-collapse:collapse;font-family:Arial,Helvetica,sans-serif;background-color:#ffffff;color:#666666;font-size:12px;line-height:18px;text-align:left">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            $subTotalAmount += $product['productprice'] * $product['productqty'];
                                            $totalGst += $product['perproductgst'];
