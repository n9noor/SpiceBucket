      ...
      <div id="invoice" class="wraaper_invoice container-fluid" style="border: 1px solid grey; border-radius: 8px; width: 660px; margin: 0px auto; padding: 28px;" width="660">
			 	...
			 	<tr>
					<td style="width: 30%; display: inline-block;" width="300">
						<a href="{{env('APP_URL')}}" style="text-align:center;" target="_blank" data-saferedirecturl="https://www.google.com/url?q={{env('APP_URL')}}&;source=gmail&amp;ust=1686467254397000&amp;usg=AOvVaw3kg-NixqNIf4tdgGhgY14_">
										   <img src="{{ URL::to('/') }}/assets/imgs/logoSB.png" height="80" width="150" alt="Spice Bucket" style="border:none" class="CToWUd" data-bit="iit">
					</td>
					<td style="width: 70%;" align="right">
						<div>
							<h6 style="font-size: 20px; margin: 0px;">SB Order ID: <strong>{{$orderID}}</strong></h6>
							<h6 style="font-size:14px; margin-top: 10px; margin-bottom: 0px;">Order Date : <strong>{{date('d/M/Y h:i A', strtotime($orderDateTime))}}</strong></h6>
		...
		<table>
		  	<tbody>
				<tr>
					<td>
						<h2><p>Dear Customer, {{ Session::get('customer-loggedin-name') }}</p></h2>
					</td>
				</tr>
				<tr>
					<td style="font-size: 14px; line-height: 20px;">
						Thank you for your order on 
						<a href="{{env('APP_URL')}}" target="_blank" data-saferedirecturl="https://www.google.com/url?q={{env('APP_URL')}}&;source=gmail&amp;ust=1686467254397000&amp;usg=AOvVaw3kg-NixqNIf4tdgGhgY14_">{{env('APP_URL')}}</a> Your order has been successfully placed. Please do
		  	...
		  	<tbody>
				...
				<tr>
					<td style="font-size: 18px;" align="left">
						<strong>  {{$vendorDetail['vendor_alias']}}</strong>
					</td>
					<!--<td align="right">
			...
			@php
               ...
               <tr style="color: #454141;">
                  ...
                  <td style="text-align: center;">
                     <i></i> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format($product['productprice'],2)}}
                  </td>
                  <td style="text-align: center;">
                     <i></i> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format($product['perproductgst'],2)}}
                  </td>
                  ...
                  <td style="text-align: center;">
					  ...
					  @php
                                    ...
                                    @endphp
									<span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format($totalcartamount,2)}}
                  </td>
               </tr>
			    @endforeach
                              @php
						...
						<td style="padding: 0px;">
							<table style="width: 100%; color:#000; font-size: 14px; border-top: none !important; ">
							  <tr style="border-bottom: 2px solid #454141;">
								 <td>Subtotal:</td>
								 <td style="float: right; text-align: right;" align="right"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format($vendorsubTotal, 2)}}</td>
							  </tr>
							  <tr style="border-bottom: 2px solid #454141 ;">
								 <td>Tax:</td>
								 <td style="float: right; text-align: right;" align="right"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($vendorGSTTotal + $gstshippingprice), 2)}}</td>
							  </tr>
							  <tr style="border-bottom: 2px solid #454141 ;">
								 <td>Shipping Fee:</td>
								 <td style="float: right; text-align: right;" align="right"> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format($baseshippingprice, 2)}}</td>
							  </tr>
							  
							  <tr style="border-bottom: 2px solid #454141;">
								 <td><b>Total Amount:</b></td>
								 <td style="float: right; text-align: right;" align="right">
									 <b><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($vendortotal + $vendorShippingCharge), 2)}}</b></td>
							  </tr>
						   </table>
						</td>
					</tr>
					...
					<td width="50%" align="right">
						<table style="width: 100%; border: 1px solid #454141; color:#000; font-size: 13px; border-top: none !important; border-collapse: collapse;">
						   <tr style="border-bottom: 2px solid #454141; border-collapse: collapse;">
							  <td>Subtotal:</td>
							  <td style="float: right; text-align: right;"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($totalSubCartAmount), 2)}}</td>
						   </tr>
						 
						   <tr style="border-bottom: 2px solid #454141 ;">
							  <td>Tax:</td>
							  <td style="float: right; text-align: right;"> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($totalGST + $totalGSTShippingPrice), 2)}}</td>
						   </tr>
						     <tr style="border-bottom: 2px solid #454141 ;">
							  <td>Shipping Fee:</td>
							  <td style="float: right; text-align: right;"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($totalBaseShippingPrice), 2)}}</td>
						   </tr>
						   <tr style="border-bottom: 2px solid #454141 ;">
							  <td>Discount:</td>
							  <td style="float: right; text-align: right;"> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($discountAmount), 2)}}</td>
						   </tr>

						  <tr style="border-bottom: 2px solid #454141 ;">
							  <td>COD Charges:</td>
							  <td style="float: right; text-align: right;"> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($cod_charges), 2)}}</td>
						   </tr>
						   ...
						   <tr style="border-bottom: 2px solid #454141 ;">
							  ...
							  <td style="float: right; text-align: right; color: red;"><b><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($totalCartAmount + $totalBaseShippingPrice + $totalGSTShippingPrice + $cod_charges - $discountAmount), 2)}}</b></td>
						   </tr>
						</table>
					</td>
				</tr>
