...
tr:nth-child(even){background-color: #f2f2f2}
    ...
    <div class="wraaper_invoice container-fluid">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                <h6>Spice Bucket Invoice ID: {{$orderID}}</h6>
                <h6>Invoice Date : {{date('d/M/Y h:i A', strtotime($orderDateTime))}}</h6>
            </div>
        </div>
        <div></div>
        <div>
            <br />
            <h5>Dear {{Session::get('customer-loggedin-name')}}</h5>
                ...
                <tbody>
                    ...
                    <tr style="color: #454141;">
                        ...
                        <td style="text-align: center;">
                            <img src="{{ env('APP_ENV') == 'production' ? url('/public/images/products/' . $product['productImage']) : url('/images/products/' . $product['productImage']) }}" alt="" height="70" width="70" class="CToWUd" data-bit="iit">
                        </td>
                        <td>
        ...
        <div style="display: flex; position: relative; justify-content: space-between; align-items: center; border: 1px solid #454141; color:#000; font-size: 13px; border-top: none !important;  ">
            <div style="width: 65%; ">
        ...
        <div style="text-align:center;">
            ...
            <div class="social_icons" style="background-color: #454141; margin-top: 20px; display: flex; align-items: center; padding: 10px 25px; justify-content: center;" class="mobile-social-icon">
                <a href="#">
