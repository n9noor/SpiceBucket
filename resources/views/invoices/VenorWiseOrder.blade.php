      ...
      <div id="invoice" class="wraaper_invoice container-fluid" style="border: 1px solid grey; border-radius: 8px; width: 660px; margin: 0px auto; padding: 28px;" width="660">
		  	...
		  	<tbody>
			 	<tr>
					...
					<td style="width: 70%;" align="right">
						<div>
							<h6 style="font-size: 20px; margin: 0px;">Order ID: <strong>{{$orderID}}</strong></h6>
							...
							<h6 style="font-size: 14px; margin: 0px;">SB Order ID: <strong>{{$orderID}}</strong></h6>
		...
		<table>
		  	<tbody>
				<tr>
					<td>
						<h2><p>Dear Seller, <!--{{ucwords($vendorDetail['vendor_alias'])}} , --></p></h2>
					</td>
				</tr>
				<tr>
					<td style="font-size: 14px; line-height: 20px;">
						you have recived an order from 
						<a href="{{env('APP_URL')}}" target="_blank" data-saferedirecturl="https://www.google.com/url?q={{env('APP_URL')}}&;source=gmail&amp;ust=1686467254397000&amp;usg=AOvVaw3kg-NixqNIf4tdgGhgY14_">{{env('APP_URL')}}</a>. Please proceed the order as soon as possible. 
					</td>
				</tr>
					...
					<td width="50%" align="right">
						<table style="width: 100%; border: 1px solid #454141; color:#000; font-size: 13px; border-top: none !important; border-collapse: collapse;">
						   <tr style="border-bottom: 2px solid #454141; border-collapse: collapse;">
							  <td>Subtotal:</td>
							  <td style="float: right ;"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($totalSubCartAmount), 2)}}</td>
						   </tr>
						 
						   <tr style="border-bottom: 2px solid #454141 ;">
							  <td>Tax:</td>
							  <td style="float: right ;"> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($totalGST + $totalGSTShippingPrice), 2)}}</td>
						   </tr>
						     <tr style="border-bottom: 2px solid #454141 ;">
							  <td>Shipping Fee:</td>
							  <td style="float: right ;"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($totalBaseShippingPrice), 2)}}</td>
						   </tr>
						     <tr style="border-bottom: 2px solid #454141 ;">
							  <td>Discount:</td>
							  <td style="float: right ;"> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($discountAmount), 2)}}</td>
						   </tr>  

						  <tr style="border-bottom: 2px solid #454141 ;">
							  <td>COD Charges:</td>
							  <td style="float: right ;"> <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format(($cod_charges), 2)}}</td>
						   </tr>
						   ...
						   <tr style="border-bottom: 2px solid #454141 ;">
							  ...
							  <td style="float: right ; color: red;"><b><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> 

							  {{number_format(($totalCartAmount + $totalBaseShippingPrice + $totalGSTShippingPrice + $cod_charges - $discountAmount), 2)}}</b></td>
						   </tr>
						</table>
					</td>
				</tr>
