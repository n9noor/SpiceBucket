...
@csrf
<script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ env('RAZOR_KEY') }}" data-amount="{{($subprice + $gst) * 100}}" data-buttontext="Pay {{$subprice + $gst}} INR" data-name="Spice Bucket" data-description="Spice Bucket Payment" data-image="{{asset('images/logo-color.png')}}" data-prefill.name="name" data-prefill.email="email" data-theme.color="#ff7529">
</script>
</form>
