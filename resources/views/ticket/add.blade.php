...
<div class="main-card mb-3 card">
    <div class="card-body">
        <form action="/ticket/save" enctype="multipart/form-data" method="post" class="form-horizontal">
            @csrf
            <div class="row">
                <div class="col-md-3">
                    <div class="position-relative mb-3">
                        ...
                        <select class="form-control" name="department" id="department">
                            ...
                            @foreach($departments as $department)
                                <option value="{{$department->id}}">{{$department->rolename}}</option>
                            @endforeach
                        </select>
                        @error('department')
                ...
                <div class="col-md-3">
                    <div class="position-relative mb-3">
                        ...
                        <select class="form-control" name="agent" id="agent" style="width:100%">
                            <option value=""></option>
                        </select>
                        @error('agent')
                        <small class="text-danger">{{$message}}</small>
