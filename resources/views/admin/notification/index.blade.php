...
<div class="app-page-title">
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <button type="button" onclick="window.location.href='/administrator/notification/{{($source == 'Seller') ?'sellers' : 'customers' }}/add'" title="Add Notification" class="btn-icon btn-shadow me-3 btn btn-dark">
                <i class="fa fa-plus btn-icon-wrapper"></i> Add {{$source}} Notification 
            </button>
        </div>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td nowrap class="text-center delete-button">
                            <a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-danger" 
                                href="/administrator/notification/{{($source == 'Seller') ?'sellers' : 'customers' }}/{{md5($notification->id)}}/edit"
                                title="Resend">
                                <i class="btn-icon-wrapper fa fa-edit"></i></a>
                            <a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-danger" 
                                href="/administrator/notification/{{($source == 'Seller') ?'sellers' : 'customers' }}/{{md5($notification->id)}}/view"
                                title="View">
