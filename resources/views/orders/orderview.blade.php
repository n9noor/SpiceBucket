            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="position-relative">
                        ...
                        <h6><strong> Contact Number:</strong> {{$orderview[0]->phonenumber}}</h6>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td nowrap="" class="align-middle text-center">
                                {{number_format((($orderdetail->net_weight/1000) * $orderdetail->product_qunatity),3)}}
                            </td>
                            <td nowrap="" class="align-middle text-center"><i class="fa fa-rupee-sign"></i> {{$orderdetail->product_price * $orderdetail->product_qunatity}}</td>
                            <td nowrap="" class="align-middle text-center"><i class="fa fa-rupee-sign"></i> {{$orderdetail->gst_on_product_price * $orderdetail->product_qunatity}}</td>
                                            ...
                                            <div class="position-relative mt-3">
                                                ...
                                                <a target="_blank" href="{{(env('APP_ENV') == "production" ? url('/public' . $orderview[0]->shipping_label) : url('' . $orderview[0]->shipping_label))}}" width="50" alt="{{$orderdetail->productname}}" class="mb-2 mr-2 btn-square btn-hover-shine btn btn-primary" id="download-label">Download label</a>
                                                  ...
                                                  @if(!empty($orderview[0]->invoice_number ))
                                                    <a target="_blank"    
                                                        href="{{url('/sellers/orders/download-invoice/'.$orderview[0]->order_id) }}"
