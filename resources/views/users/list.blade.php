...
<tr>
<td>
<a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-primary" href="/administrator/edit-user/{{$user->id}}"><i class="btn-icon-wrapper fa fa-user"></i>Edit User</a>
<a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-danger" href="/administrator/delete-user/{{$user->id}}"><i class="btn-icon-wrapper fa fa-trash"></i>Delete User</a>
</td>
