                ...
                <div class="card">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">SB Order ID: {{$orderID}}</h5>
                        </div>
                        <div class="card-body">
                            <div class="customer-order-detail">
                                <div class="row dorder-header-sec">
                                    ...
                                    <div class="col-auto">
                                        <div class="order-meta"><span class="d-inline-block">Time:</span> <strong class="order-detail-value">{{date('d/M/Y h:i A', strtotime($orderDateTime))}}</strong></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
											...
											<div class="row">
												<div class="col-6 pt-2">
													...
													<div>
														...
														<div><span class="d-inline-block">Payment method:</span> <strong class="order-detail-value"> {{ $vendorDetail['paymentSource'] == 'cod' ? "Cash on Delivery (COD)" : ucfirst($vendorDetail['paymentSource']) }}</strong></div>
														<div><span class="d-inline-block">Payment status:</span> <strong class="order-detail-value"> Pending</strong></div>
														<div><span class="d-inline-block">Amount:</span> <strong class="order-detail-value"><i class="fa fa-rupee-sign"></i> {{number_format($totalCartAmount, 2)}}</strong></div>
														<div><span class="d-inline-block">Tax:</span> <strong class="order-detail-value"><i class="fa fa-rupee-sign"></i> {{number_format($totalGST + $totalGSTShippingPrice, 2)}}</strong></div>
														<div><span class="d-inline-block">Discount:</span> <strong class="order-detail-value"><i class="fa fa-rupee-sign"> {{number_format($discountAmount, 2)}}</i>
															</strong></div>
														<div><span class="d-inline-block">Shipping fee:</span> <strong class="order-detail-value"><i class="fa fa-rupee-sign"></i>{{number_format($totalBaseShippingPrice, 2)}} </strong></div>
														@if($cod_charges > 0)
														<div><span class="d-inline-block">COD Charges:</span> <strong class="order-detail-value"><i class="fa fa-rupee-sign"></i>{{number_format($cod_charges, 2)}} </strong></div>
														@endif

                                                        <div><span class="d-inline-block">Total Amount:</span> <strong class="order-detail-value"><i class="fa fa-rupee-sign"></i> {{number_format(($totalCartAmount + $totalBaseShippingPrice + $totalGSTShippingPrice + $cod_charges - $discountAmount), 2)}}</strong></div>
												...
												<div class="col-6 pt-2 text-end">
													<h4>Customer</h4>
													<div>
														<div><span class="d-inline-block">Full Name:</span> <strong class="order-detail-value">{{$CustomerDetail['firstname']}} {{$CustomerDetail['lastname']}}</strong></div>
														<div><span class="d-inline-block">Phone:</span> <strong class="order-detail-value">{{$CustomerDetail['phonenumber']}} </strong></div>
														<div><span class="d-inline-block">Email:</span> <strong class="order-detail-value">{{$CustomerDetail['email']}}</strong></div>
														<div class="row">
															<div class="col-12"><span class="d-inline-block">Billing Address:</span> <strong class="order-detail-value">{{$CustomerDetail['billingAddress']}} </strong><br>
                                                    ...
                                                    <div class="row">
														...
														<div class="col-md-4">
                                                         <div class="track-order">
                                                                ...
                                                                <div class="col-auto me-auto text-end mb-3" id="trackorder"><a href="javascript:void(0)" onclick="trackYourOrder ('{{$orderdetails[0]->orderid}}', '{{$orderdetail['vendorID']}}')" class="btn btn-info btn-sm" id="trackOrder_pop">Track</a></div>
                                                                <!-- Modal -->
                                                                <!-- The Modal -->
