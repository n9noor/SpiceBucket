...
class HomeController extends Controller
{
    ...
    public function vendor_view(Request $request, $slug)
    {
        ...
        return view('brand', ['activePage' => '', 'products' => $products, 'headercategories' => $headercategories, 'vendors' => $vendors, 'header' => ($header == null ? array() : json_decode($header->description, true)), 'footer' => ($footer == null ? array() : json_decode($footer->description, true)), 'categories' => $categories, 'selectedvendor' => $selectedvendor, 'popularstores' => $popularstores]);
    }
    ...
    public function getOrderInvoice(Request $request){
        ...
        return view('invoice', ['vendorWiseDetail' => $vendorWiseDetail, 'orderDetail' => $orderDetails, 'orderID' => $orderID, 'orderDateTime' => $orderDateTime, 'discountAmount' => $cartDiscount, 'cod_charges' => $codOnCart, 'paymentSource' => $paymentSource,'productReview'=>$productReview]);


    }
    public function getOrderInvoice_bkp(Request $request)
    {
