        ...
        <div class="table-responsive">
            <table class="table table-bordered dark" style="width:100%; overflow-x:scroll; overflow-y:auto !important;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td nowrap><a href="/sellers/orders/view/{{$order->idoforder}}/{{$order->vendor_id}}">{{$order->orderid}}</a></td>
                        ...
                        @endphp
                        <td style="text-align: center;" nowrap><i class="fa fa-rupee-sign"></i> {{number_format($order->totalOrderPrice, 2)}} </td>
                        <td  style="text-align: center;" nowrap><i class="fa fa-rupee-sign"></i> {{number_format(($order->OrderGSTPrice + $gstshippingprice), 2)}} </td>
                        @if($order->discount > 0)
