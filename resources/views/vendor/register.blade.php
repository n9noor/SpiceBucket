                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input name="shop_name" id="shop_name" placeholder="Enter Company Name" type="text" class="form-control" value="{{old('shop_name')}}">
                                                @error('shop_name')
                                                <small class="text-danger">{{$message}}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input name="owner_name" id="owner_name" placeholder="Enter name" type="text" class="form-control" value="{{old('owner_name')}}">
                                                @error('owner_name')
                                                <small class="text-danger">{{$message}}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input name="brand_name" id="brand_name" placeholder="Enter Brand Name" type="text" class="form-control" value="{{old('brand_name')}}">
                                                @error('brand_name')
                                                <small class="text-danger">{{$message}}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input name="email" id="email" placeholder="Enter Business Email here" type="email" class="form-control" value="{{old('email')}}">
                                                @error('email')
                                                <small class="text-danger">{{$message}}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input name="phone" id="phone" placeholder="Eneter Mobile Number" type="text" class="form-control" value="{{old('phone')}}">
                                                @error('phone')
                                                <small class="text-danger">{{$message}}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input name="shipping_pincode" id="shipping_pincode" placeholder="Enter Pincode" type="text" class="form-control" value="{{old('shipping_pincode')}}">
