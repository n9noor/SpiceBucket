...
<tr>
<td>
<a onclick="$('#document_type_id').val({{$type->id}});$('#document_type').val('{{$type->type}}');" data-bs-toggle="modal" data-bs-target="#add-document-type-modal" class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-primary" href="javascript:void(0)"><i class="btn-icon-wrapper fa fa-user"></i>Edit Type</a>
<a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-danger" href="javascript:void(0)"><i class="btn-icon-wrapper fa fa-trash"></i>Delete Type</a>
</td>
