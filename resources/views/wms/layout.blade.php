...
<head>
    ...
    <link href="{{asset('backend/styles/css/base.css?v=1.0')}}" rel="stylesheet">
                    ...
                    <div class="header-dots">
                        <div class="dropdown">
                                @if(session('vendor-logged-in') == true)
                                    <a {{Request::url() == env('APP_URL').'/sellers/notification' ? "class=active" : ""}} 
                                        title="Notifications" 
                                        href="/sellers/notification">

                                       <span class="notifi_count">{{session('notificationCount')}}</span>
                                        <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                                            <span class="icon-wrapper-bg bg-danger"></span>
                                            <i class="icon text-danger icon-anim-pulse ion-android-notifications"></i>
                                            <span class="badge badge-dot badge-dot-sm bg-danger notifi_count">Notifications {{session('notificationCount')}}</span>
                                        </span>
                                    </a>
                                @else
                                    <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-right me-2">
                                                                    <button class="btn-pill btn-shadow btn-shine btn btn-focus" onclick="window.location.href='/{{session("vendor-logged-in") == true ? "sellers" : "administrator"}}/logout';">Logout</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
-->
                                                        <li class="nav-item">
                                                            <a href="{{session('vendor-logged-in') == true ? "/sellers/my-profile" : "javascript:void(0)"}}" class="nav-link">Profile</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a {{Request::url() == env('APP_URL').'/sellers/dashboard' ? "class=active" : ""}} href="/sellers/dashboard">
                                    <i class="metismenu-icon pe-7s-rocket"></i>
                                    Dashboard
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/products/categories' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/products/categories" : "javascript:void(0)"}}">
                                    <i class="metismenu-icon pe-7s-umbrella"></i>
                                    Category
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/products/list' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/products/list" : "javascript:void(0)"}}">
                                    <i class="metismenu-icon pe-7s-ball"></i>
                                    Products
                                </a>
                            </li>
                            <li>
                                <a title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="javascript:void(0)">
                                ...
                                <ul>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/report/order' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/report/order" : "javascript:void(0)"}}">
                                            <i class="metismenu-icon"></i>
                                            Order Details
                                        </a>
                                    </li>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/report/invoice-tax' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/report/invoice-tax" : "javascript:void(0)"}}">
                                            <i class="metismenu-icon"></i>
                                            Invoice Tax Details
                                        </a>
                                    </li>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/report/sale-summary' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/report/sale-summary" : "javascript:void(0)"}}">
                                            <i class="metismenu-icon"></i>
                                            Sale Summary
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a {{Request::url() == env('APP_URL').'/sellers/orders' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/sellers/orders" : "javascript:void(0)"}}">
                                    <i class="metismenu-icon pe-7s-photo-gallery"></i>
                                    Order
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <!--<li>
                                        <a title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "" : "javascript:void(0)"}}" data-bs-toggle="modal" data-bs-target="#coming-soon-modal">
                                            <i class="metismenu-icon"></i>
                                            Store Policy
                                        </a>
                                    </li>-->
                                    ...
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/sellers/settings' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/sellers/settings" : "javascript:void(0)"}}">
                                            <i class="metismenu-icon"></i>
                                            Global Setting
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a {{Request::url() == env('APP_URL').'/sellers/users' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/sellers/users" : "javascript:void(0)"}}">
                                    <i class="metismenu-icon pe-7s-photo-gallery"></i>
                                    Users
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/sellers/roles' ? "class=active" : ""}} title="{{session('vendor-loggedin-approved') == 1 ? "" : "Please upload document, and get it approved"}}" href="{{session('vendor-loggedin-approved') == 1 ? "/sellers/roles" : "javascript:void(0)"}}">
                                    <i class="metismenu-icon pe-7s-photo-gallery"></i>
                                    Roles
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/sellers/ticket' ? "class=active" : ""}} href="/sellers/ticket">
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a {{Request::url() == env('APP_URL').'/administrator' ? "class=active'" : ""}} href="/administrator">
                                    <i class="metismenu-icon pe-7s-rocket"></i>
                                    Dashboard
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/administrator/vendor-document-type' ? "class='active'" : ""}} href="/administrator/vendor-document-type">
                                            <i class="metismenu-icon"></i>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/administrator/users' ? "class=active" : ""}} href="/administrator/users">
                                            <i class="metismenu-icon"></i>
                                            List
                                        </a>
                                    </li>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/administrator/roles' ? "class=active" : ""}} href="/administrator/roles">
                                            <i class="metismenu-icon"></i>
                                            Departments
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a {{Request::url() == env('APP_URL').'/sellers/list' ? "class=active" : ""}} href="/sellers/list">
                                    <i class="metismenu-icon pe-7s-cloud-upload"></i>
                                    Sellers
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/products/categories' ? "class=active" : ""}} href="/products/categories">
                                    <i class="metismenu-icon pe-7s-cloud-upload"></i>
                                    Categories
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/products/list' ? "class=active" : ""}} href="/products/list">
                                    <i class="metismenu-icon pe-7s-cloud-upload"></i>
                                    Product
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/report/order' ? "class=active" : ""}} href="/report/order">
                                            <i class="metismenu-icon"></i>
                                            Order Details
                                        </a>
                                    </li>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/report/invoice-tax' ? "class=active" : ""}} href="/report/invoice-tax">
                                            <i class="metismenu-icon"></i>
                                            Invoice Tax Details
                                        </a>
                                    </li>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/report/sale-summary' ? "class=active" : ""}} href="/report/sale-summary">
                                            <i class="metismenu-icon"></i>
                                            Sale Summary
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a {{Request::url() == env('APP_URL').'/administrator/customers' ? "class=active" : ""}} href="/administrator/customers">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Customers
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/offer/list' ? "class=active" : ""}} href="/offer/list">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Offers
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/administrator/coupons' ? "class=active" : ""}} href="/administrator/coupons">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Discount Coupons
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/administrator/static-page' ? "class=active" : ""}} href="/administrator/static-page">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Static Page
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/administrator/faq' ? "class=active" : ""}} href="/administrator/faq">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    FAQ
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/ticket' ? "class=active" : ""}} href="/ticket">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Tickets
                                </a>
                            </li>
                            ...
                            <li>
                                <a {{Request::url() == env('APP_URL').'/administrator/mail' ? "class=active" : ""}} href="/administrator/mail">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Mail
                                </a>
                            </li>
                            <li>
                                <a {{Request::url() == env('APP_URL').'/administrator/message' ? "class=active" : ""}} href="/administrator/message">
                                    <i class="metismenu-icon pe-7s-users"></i>
                                    Message 
                                </a>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/administrator/notification/sellers' ? "class=active" : ""}} 
                                    ...
                                    <li>
                                        <a {{Request::url() == env('APP_URL').'/administrator/notification/customers' ? "class=active" : ""}} 
