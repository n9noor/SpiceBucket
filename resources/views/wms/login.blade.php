...
<title>Login - Spice Bucket Administrator</title>
...
<div class="slide-img-bg" style="background-image: url('{{asset('backend/images/originals/spices-wooden-board-spoons.jpg')}}');"></div>
...
<div class="slide-img-bg" style="background-image: url('{{asset('backend/images/originals/spoons-with-powder-condiments-copy-space.jpg')}}');"></div>
<div class="slider-content">
<h3>&nbsp;</h3>
<p>&nbsp;</p>
</div>
...
@endif
<form method="post" action="/administrator" class="form-horizontal">
@csrf
<div class="row">
<div class="col-md-6">
<div class="position-relative mb-3">
<label for="loginusername" class="form-label">Email</label>
<input name="email" id="loginusername"
placeholder="Email here..." type="email" class="form-control" value="{{ old('email') }}" />
@error('email')
...
<input name="password" id="loginpassword"
...
<script type="text/javascript" src="{{asset('backend/vendors/slick-carousel/slick/slick.min.js')}}"></script>
<!-- custome.js -->
<script type="text/javascript" src="{{asset('backend/js/carousel-slider.js')}}"></script>
</body>
</html>
