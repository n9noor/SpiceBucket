                                ...
                                <form action="" method="GET">
                                    ...
                                    <div class="widget-category-2 mb-30 widget-filter-item">
                                        ...
                                        <div class="custome-checkbox">
                                            ...
                                            <input class="form-check-input" name="searchcategories[]" type="checkbox" id="seller-sidebar-category-filter-{{ $category->id }}" value="{{ $category->id }}" @if (in_array($category->id, (array)request()->input('searchcategories', []))) checked @endif>
