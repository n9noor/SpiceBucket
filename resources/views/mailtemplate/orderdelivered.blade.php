        ...
        <div align="center" style="margin:0 auto">
            <div style="text-align:center;background-color:#ffffff;margin-top:1.0em">
                <table cellpadding="5" cellspacing="0" border="0" width="100%" style="font-family:Arial,Helvetica,sans-serif;background-color:#ffffff;color:#666666;border-bottom:solid 4px #e2e2e2;font-size:12px;text-align:left">
                    <tbody>
                        <tr>
                            <td style="text-align:center;padding-bottom:10px"><a href="https://www.spicebucket.com" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://www.spicebucket.com&amp;source=gmail&amp;ust=1680422534604000&amp;usg=AOvVaw3OnhuDBWeUqmxqjR6MG3rl"><img src="https://ci6.googleusercontent.com/proxy/oGo-KRmd4aI5rruX-VH21_8VbKDSY873YDUD8vxmkIt0dW0j7-nrxFIuE-OYXq7llXCCG31FERmvTbDNb_dBIsb7Cg8YQ5Umd5AKdc0nNO9H-MqDfE-A-yURkgwDX3LH9KtkGBwgLBSthaKe8JfpaXuzbQzXZxo=s0-d-e1-ft#https://cdn.shopaccino.com/spicebucket/images/footer-logo-spicebucket-222236_logo.png?ver=2132794650" alt="Spice Bucket" style="border:none" class="CToWUd" data-bit="iit"></a></td>
                        </tr>
                        <tr>
                            <td style="text-align:center;padding-bottom:10px;color:#8b8c83;border-bottom:solid 1px #e2e2e2;font-size:18px">Your order 9926 is delivered</td>
                        </tr>
                        <tr>
                            <td style="font-weight:bold;padding-top:10px">Dear NEHA GUPTA,</td>
                        </tr>
                        <tr>
                            <td>We are pleased to inform you that your order has been successfully delivered from <a href="https://www.spicebucket.com" style="text-decoration:none;color:#0d88ce" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://www.spicebucket.com&amp;source=gmail&amp;ust=1680422534605000&amp;usg=AOvVaw1D4MqCEJFBxp5yjU7diRCI">Spice Bucket</a> !</td>
                        </tr>
                        <tr>
                            <td>Below, you will find details for the items that have been delivered.</td>
                        </tr>
                        <tr>
                            <td>
                                @php $totalGST = 0;
