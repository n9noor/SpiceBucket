            ...
            <div style="text-align:center;background-color:#ffffff;margin-top:1.0em">
                <table cellpadding="5" cellspacing="0" border="0" width="100%" style="font-family:Arial,Helvetica,sans-serif;background-color:#ffffff;color:#666666;border-bottom:solid 4px #e2e2e2;font-size:12px;text-align:left">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-weight:bold;padding-top:10px">Dear Seller, <!--{{Session::get('customer-loggedin-name')}}--></td>
                        </tr>
                        <tr>
                            <td>You have successfully received an order from <a href="https://www.spicebucket.com">https://www.spicebucket.com.</a> 
                            </td>
                        </tr>
                        <tr>
                            <td>Below, you will find details for the order that you have received from <a href="https://www.spicebucket.com">https://www.spicebucket.com.</a></td>
                        </tr>
                        <tr>
                            <td>
                                @php
                                ...
                                <table cellpadding="5" cellspacing="0" border="0" width="100%" style="font-family:Arial,Helvetica,sans-serif;background-color:#ffffff;color:#666666;font-size:12px;text-align:left">
                                    <tbody>
                                        <tr>
                                            <td colspan="2">
                                                <strong>Order No: {{@($vendorDetail['invoiceNumber'])?$vendorDetail['invoiceNumber']:$vendorDetail['orderID']}}</strong>
                                                <br>
                            ...
                            <table cellpadding="5" cellspacing="0" border="1" width="100%" style="border:solid 1px #f2f2f2;border-collapse:collapse;font-family:Arial,Helvetica,sans-serif;background-color:#ffffff;color:#666666;font-size:12px;line-height:18px;text-align:left">
                                ...
                                <tr style="">
                                    ...
                                    <th width="100" style="width:100px; border: 1px solid #454141; text-align: center;">Shipping:</th>
                                    <th width="150" style="width:100px; border: 1px solid #454141; text-align: center;">Grand Total:</th>
                                </tr>

                                <tr>
                                    <td style="width: 100px; border: 1px solid #454141; text-align: center;" width="100"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span>{{number_format($subamount, 2)}}</td>
                                    <td style="width: 100px; border: 1px solid #454141; text-align: center;" width="100"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($gstamount + $gstshippingprice), 2)}}</td>
                                    <td style="width: 100px; border: 1px solid #454141; text-align: center;" width="100"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format($vendorDetail['discount'], 2)}}</td>
                                    <td style="width: 150px; border: 1px solid #454141; text-align: center;" width="150"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format($baseshippingprice, 2)}}</td>
                                    <td style="width: 200px; border: 1px solid #454141; text-align: center; color: #e3273A;" width="200"><b><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($subamount + $gstamount - $vendorDetail['discount'] + $vendorDetail['shippingFee']), 2)}}</b></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><i class="fa fa-rupee-sign"></i> {{number_format($totalGst,2)}} (included) </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    @php $deliveryFee = 0;
                                    if($subTotalAmount <= 149 ){ $deliveryFee=50; } elseif($subTotalAmount <=349 && $subTotalAmount> 149){
                                        $deliveryFee = 70;
                                        }
                                        elseif($subTotalAmount <= 498 && $subTotalAmount> 349 ){
                                            $deliveryFee = 100;
                                            }
                                            else{
                                            $deliveryFee = 0;
                                            ...
                                            @endphp
                                            <td><i class="fa fa-rupee-sign"></i> {{number_format($deliveryFee,2)}}</td>
                                </tr>

                                <tr>
                                    <td>&nbsp;</td>
                                    <td><strong>Grand Total</strong></td>
                                    <td><i class="fa fa-rupee-sign"></i> {{number_format($subTotalCartAmount + $deliveryFee)}} </td>
                                </tr>-->
                            </table>
                        </tr>
                        <tr>
