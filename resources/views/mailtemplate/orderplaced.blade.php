			...
			<div style="text-align:center;background-color:#ffffff;margin-top:1.0em">
				<table cellpadding="5" cellspacing="0" border="0" width="100%" style="font-family:Arial,Helvetica,sans-serif;background-color:#ffffff;color:#666666;border-bottom:solid 4px #e2e2e2;font-size:12px;text-align:left">
					<tbody>
						...
						<tr>
							<td style="font-weight:bold;padding-top:10px">Dear Customer, {{Session::get('customer-loggedin-name')}}</td>
						</tr>
						<tr>
							...
							<td>
								...
								<div style="width: 800px;">
									...
									<table style="width: 100%; border: 1px solid #454141; color:#000; font-size: 13px; border-collapse: collapse;">
										...
										<tr>
											<td nowrap="" style="width: 100px; border: 1px solid #454141; text-align: center;" width="100"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($totalSubCartAmount), 2)}}</td>
											<td nowrap="" style="width: 100px; border: 1px solid #454141; text-align: center;" width="100"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($totalGST + $totalGSTShippingPrice), 2)}}</td>
											<td nowrap="" style="width: 100px; border: 1px solid #454141; text-align: center;" width="100"> (-) <span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($discountAmount), 2)}}</td>
											<td nowrap="" style="width: 150px; border: 1px solid #454141; text-align: center;" width="150"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($totalBaseShippingPrice), 2)}}</td>
											<td nowrap="" style="width: 150px; border: 1px solid #454141; text-align: center;" width="150"><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($cod_charges), 2)}}</td>
											<td nowrap="" style="width: 200px; border: 1px solid #454141; text-align: center; color: #e3273A;" width="200"><b><span><img src="{{ URL::to('/') }}/images/indian-rupee-sign.png"  width="8" alt="Rupees SB" style="border:none" class="CToWUd" data-bit="iit"></span> {{number_format(($totalCartAmount + $totalBaseShippingPrice + $totalGSTShippingPrice + $cod_charges - $discountAmount), 2)}}</b></td>
										</tr>	
									</table>
								</div>
							</td>
