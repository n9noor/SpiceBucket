...
<main class="main pages">
    ...
    <div class="page-header breadcrumb-wrap">
        ...
        <div class="container">
            ...
            <div class="breadcrumb">
                ...
                <span></span><a href="/brand/{{$product->vendor_slug}}">{{(is_null($product->vendorNickName) || empty($product->vendorNickName)) ? $product->vendorName : $product->vendorNickName }}</a>
    ...
    <div class="">
        ...
        <input type="hidden" name="quickview_productid" id="quickview_productid" value="{{ $product->id }}" />

        <input type="hidden" name="vendor_shipping_pincode" id="vendor_shipping_pincode" value="{{ $product->vendor_shipping_pincode }}" />
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="gallery_pdp_container">
                                    ...
                                    <div id="gallery_pdp">
                                        ...
                                        @php $varianttimages = !is_null($image) ? explode("|", $image) : array(); @endphp

                                        <a href="{{ array_key_exists(1, $varianttimages) ? (env('APP_ENV') == 'production' ? url('/public/images/products/' . $varianttimages[1]) : url('/images/products/' . $varianttimages[1])) : url('/assets/imgs/no-image-placeholder.png') }}" data-image="{{ array_key_exists(1, $varianttimages) ? (env('APP_ENV') == 'production' ? url('/public/images/products/' . $varianttimages[1]) : url('/images/products/' . $varianttimages[1])) : url('/assets/imgs/no-image-placeholder.png') }}" data-zoom-image="{{ array_key_exists(1, $varianttimages) ? (env('APP_ENV') == 'production' ? url('/public/images/products/' . $varianttimages[1]) : url('/images/products/' . $varianttimages[1])) : url('/assets/imgs/no-image-placeholder.png') }}"><img class="img-thumbnail small_img" src="{{ array_key_exists(1, $varianttimages) ? (env('APP_ENV') == 'production' ? url('/public/images/products/' . $varianttimages[1]) : url('/images/products/' . $varianttimages[1])) : url('/assets/imgs/no-image-placeholder.png') }}" alt="{{ $product->name }}"></a>
                            ...
                            <div class="col-md-10">
                                <div class="gallery-viewer">
                                    ...
                                    <img id="zoom_10" width="100%" height="100%" src="{{ env('APP_ENV') == 'production' ? url('/public/images/products/' . $product->defaultImage) : url('/images/products/' . $product->defaultImage) }}" data-zoom-image="{{ env('APP_ENV') == 'production' ? url('/public/images/products/' . $product->defaultImage) : url('/images/products/' . $product->defaultImage) }}" class="big_img" />
                    ...
                    <div class="col-md-6 pdp-image2-gallery-block w-100">
                        <ul id="imageGallery">
                            ...
                            @php $varianttimages = !is_null($image) ? explode("|", $image) : array(); @endphp
                            <li data-thumb="{{ array_key_exists(1, $varianttimages) ? (env('APP_ENV') == 'production' ? url('/public/images/products/' . $varianttimages[1]) : url('/images/products/' . $varianttimages[1])) : url('/assets/imgs/no-image-placeholder.png') }}" data-src="{{ array_key_exists(1, $varianttimages) ? (env('APP_ENV') == 'production' ? url('/public/images/products/' . $varianttimages[1]) : url('/images/products/' . $varianttimages[1])) : url('/assets/imgs/no-image-placeholder.png') }}">
                                <img src="{{ array_key_exists(1, $varianttimages) ? (env('APP_ENV') == 'production' ? url('/public/images/products/' . $varianttimages[1]) : url('/images/products/' . $varianttimages[1])) : url('/assets/imgs/no-image-placeholder.png') }}" data-slide-no="{{$key}}" />
                            </li>
                            @endforeach
                        </ul>
                    </div>
                        ...
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <div class="clearfix product-price-cover">
                                ...
                                <div class="product-price primary-color float-left"> 
                                    <span class="current-price text-brand">
                                        ...
                                        <span id="product-price">{{ $product->netPrice }}</span>
                                    </span>

                                    <span> 
                                        <span class="save-price font-md color3 ml-15"> 
                                            <span class="percentage-off">({{number_format($product->discountPercentage, 1)}}% off)</span> 
                                        </span> 
                            ...
                            <div class="old-pricing-sec">
                                    ...
                                    <span class="product-mrp-name">M.R.P</span>
                                            ...
                                            <del><span class="old-price font-md ml-5" id="product-mrp"> {{ $product->product_mrp}}
                            ...
                            <div class="short-desc mb-10">
                                ...
                                <p>Visit: <a href="/brand/{{$product->vendor_slug}}"><strong>{{ (is_null($product->vendorNickName) || empty($product->vendorNickName)) ? $product->vendorName : $product->vendorNickName }}</strong></a></p>
                            ...
                            <div class="pr_switch_wrap">
                                ...
                                <div class="product-attributes">
                                    ...
                                    <input type="hidden" name="product-price-variant-id" id="product-price-variant-id" value="{{$product->variantpriceid}}" />
                                                ...
                                                <div class="dropdown-swatch">
                                                    ...
                                                    <label>
                                                        ...
                                                        <ul class="text-swatch attribute-swatch color-swatch">
                                                            ...
                                                            <li data-id="{{ $variantvalue[1]}}" class="attribute-swatch-item ">
                            ...
                            <div class="font-xs innner-bread">
                                ...
                                <ul>
                                    ...
                                    <li class="" style="margin-top:0px;"> <span class="d-inline-block">Categories:</span> <a href="/product-categories/{{$product->category_slug}}" title="{{ $product->categoryName }}">{{ $product->categoryName }}</a>
                    ...
                    <div class="tab-style3">
                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            ...
                            <div id="tab-vendor" class="tab-pane fade">
                                ...
                                <div class="vendor-logo d-flex mb-30"><img src="/assets/imgs/no-image-available.jpg" alt="{{$product->vendorName}}">

                                    <div class="vendor-name ml-15">

                                        <h6><a href="/brand/{{$product->vendor_slug}}">{{$product->vendorName}}</a></h6>
                            ...
                            <!--<ul class="contact-infor mb-50">
                                    ...
                                    <li><img src="/assets/imgs/icon-location.svg" alt="Address"><strong>Address: </strong><span>{{$product->vendor_address}}</span></li>

                                    <li><img src="/assets/imgs/icon-contact.svg" alt="Contact Seller"><strong>Contact Seller:</strong><span>(+91) - {{$product->vendor_phone}}</span></li>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="block__content comment-list">
                                                ...
                                                <div class="block--review single-comment justify-content-between d-flex mb-30">
                                                    ...
                                                    <div class="user justify-content-between d-flex">
                                                        ...
                                                        <div class="thumb text-center"><img src="/assets/imgs/user.jpg" alt="{{$review['customer_name']}}"> <span class="font-heading text-brand d-block">{{$review['customer_name']}}</span></div>

                                                        <div class="desc">

                                                            <div class="d-flex justify-content-between mb-10">

                                                                <div> <span class="font-xs text-muted">{{$review['time_difference']}}</span></div>
                                                            ...
                                                            <div class="block__images">
                                                                ...
                                                                @endphp 
                                                                <a href="{{ImageRender($imagearray)}}"><img src="{{ImageRender($imagearray)}}" alt="{{ImageRender($imagearray)}}" class="img-responsive rounded h-100"></a>
                                                                @endforeach
                                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <h6>{{$productreviewcount['avg']}} out of 5</h6>

                                            </div>

                                            <div class="progress"><span>5 star</span>

                                                <div role="progressbar" aria-valuenow="{{$productreviewcount['star5']}}" aria-valuemin="0" aria-valuemax="100" class="progress-bar page_speed_562526235">{{$productreviewcount['star5']}}%</div>

                                            </div>

                                            <div class="progress"><span>4 star</span>

                                                <div role="progressbar" aria-valuenow="{{$productreviewcount['star4']}}" aria-valuemin="0" aria-valuemax="100" class="progress-bar page_speed_1415130164">{{$productreviewcount['star4']}}%</div>

                                            </div>

                                            <div class="progress"><span>3 star</span>

                                                <div role="progressbar" aria-valuenow="{{$productreviewcount['star3']}}" aria-valuemin="0" aria-valuemax="100" class="progress-bar page_speed_2013111614">{{$productreviewcount['star3']}}%</div>

                                            </div>

                                            <div class="progress"><span>2 star</span>

                                                <div role="progressbar" aria-valuenow="{{$productreviewcount['star2']}}" aria-valuemin="0" aria-valuemax="100" class="progress-bar page_speed_2013111614">{{$productreviewcount['star2']}}%</div>

                                            </div>

                                            <div class="progress"><span>1 star</span>

                                                <div role="progressbar" aria-valuenow="{{$productreviewcount['star1']}}" aria-valuemin="0" aria-valuemax="100" class="progress-bar page_speed_2013111614">{{$productreviewcount['star1']}}%</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            ...
                                            <form method="POST" action="javascript:void(0)" accept-charset="UTF-8" enctype="multipart/form-data" class="form-contact comment_form form-review-product">
                                                ...
                                                <p class="text-danger">@if(Session::get('customer-logged-in') != true) Please <a href="/login">login</a> to write review!</p> @endif<input type="hidden" name="product_id" value="{{ $product->id }}">
                                                ...
                                                <div class="form-group"><textarea name="comment" id="comment" cols="30" rows="9" placeholder="Write Comment" {{Session::get('customer-logged-in') == true ? "" : 'disabled="disabled"'}} class="form-control w-100"></textarea></div>
                            ...
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2>
                                        ...
                                        @if(url()->current() == env('APP_URL') . "/product/$product->slug")
                                    ...
                                    <div>
                                        ...
                                        <span class="font-small text-muted">Visit Store: <a href="/brand/{{ $product->vendor_slug }}" target="_blank">{{!is_null($product->vendorNickName) && !empty($product->vendorNickName) ? $product->vendorNickName :$product->vendorName }}</a></span>
