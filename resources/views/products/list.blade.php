    ...
    <div class="g-0 row pt-3 pb-2 px-3">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab-content-product" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="position-relative mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Seller Name" value="{{old('name')}}">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="position-relative mb-3">
                                ...
                                <select class="form-control" name="approve_status" id="approve_status">
                                    ...
                                    <option value="approved" {{old('approve_status') == 'approved' ? "selected='selected'":""}}>Approved</option>
                                    <option value="disapproved" {{old('approve_status') == 'disapproved' ? "selected='selected'":""}}>Disapproved</option>
                                    <option value="pending" {{old('approve_status') == 'pending' ? "selected='selected'":""}}>Pending</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                @if(Session::get('vendor-logged-in') == true || (Session::get('admin-logged-in') == true && Session::get('admin-loggedin-property')['product-list-view'] == 1))
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td nowrap="">
                                    ...
                                    <a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-primary" href="/products/edit-product/{{$product->id}}"><i class="btn-icon-wrapper fa fa-edit"></i></a>
                                    @endif
                                    @if(Session::get('admin-logged-in') == true && Session::get('admin-loggedin-property')['product-list-edit'] == 1)
                                    <a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-primary" href="/products/view-product/{{$product->id}}"><i class="btn-icon-wrapper fa fa-edit"></i></a>
                                    @endif
                                    <a class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-danger" href="/products/delete-product/{{$product->id}}"><i class="btn-icon-wrapper fa fa-trash"></i></a>


                                    <a target="_blank" class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-warning" href="/products/view-live-product/{{$product->id}}"><i class="btn-icon-wrapper fa fa-eye"></i></a>
                                </td>
                                ...
                                @if(session('admin-logged-in') == true && Session::get('admin-loggedin-property')['product-list-approve'] == 1)
                                @if($product->is_approved == 0)
                                <td>

                                    <a data-id='{{$product->id}}' class="btn-icon btn-shadow btn-outline-2x btn btn-outline-success product-approve" href="javascript:void(0)"><i class="fa fa-check"></i></a>
                                    <a onclick="$('#product').val({{$product->id}});" data-bs-toggle="modal" data-bs-target="#decline-comment-modal" class="btn-icon btn-shadow btn-outline-2x btn btn-outline-danger product-not-approve" href="javascript:void(0)"><i class="fa fa-times"></i></a>
                                </td>
