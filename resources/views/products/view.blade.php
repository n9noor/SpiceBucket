            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="position-relative mb-3">
                        ...
                        <select disabled class="multiselect-dropdown form-control" name="main_category_id" id="main_category_id" placeholder="Select category">
                            <option value=""></option>
                ...
                <div class="col-md-2">
                    <div class="position-relative mb-3">
                        ...
                        <select disabled class="multiselect-dropdown form-control" name="sub_category_id" id="sub_category_id" placeholder="Select category">
                            <option value=""></option>
                ...
                <div class="col-md-3">
                    <div class="position-relative mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input disabled class="form-check-input" {{ $product->product_type == 1 ? " checked='checked'" : ""}} type="radio" name="product_type" id="product_type_veg" value="1">
                            <label class="form-check-label" for="product_type_veg">Veg</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input disabled class="form-check-input" {{ $product->product_type == 2 ? " checked='checked'" : ""}} type="radio" name="product_type" id="product_type_nonveg" value="2">
                            <label class="form-check-label" for="product_type_nonveg">Non Veg</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input disabled class="form-check-input" {{ $product->product_type == 0 ? " checked='checked'" : ""}} type="radio" name="product_type" id="product_type_na" value="0">
                ...
                <div class="{{session('admin-logged-in') == true ? 'col-md-3' : 'col-md-5' }}">
                    <div class="position-relative mb-3">
                        ...
                        <input readonly type="text" class="form-control" name="name" id="name" placeholder="Enter name" value="{{$product->name}}" />
                        @error('name')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="col-md-2">
                    <div class="position-relative mb-3">
                        ...
                        <select disabled class="form-control" name="vendor_id" id="vendor_id" placeholder="Select Vendor">
                            <option value=""></option>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="position-relative mb-3">
                        ...
                        <textarea readonly class="form-control" name="summary" id="summary" placeholder="Enter Summary">{{$product->summary}}</textarea>
                        @error('summary')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="position-relative mb-3">
                        ...
                        <textarea readonly class="form-control" name="description" id="description" placeholder="Enter Description">{{$product->description}}</textarea>
                        @error('description')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="position-relative mb-3">
                                ...
                                <input readonly type="text" name="hsn_code" id="hsn_code" class="form-control" placeholder="Enter HSN Code" value="{{$product->hsn_code}}">
                                @error('hsn_code')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="position-relative mb-3">
                                ...
                                <select disabled name="gst_rate" id="gst_rate" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="position-relative mb-3">
                                ...
                                <input readonly type="text" name="sku" id="sku" class="form-control" placeholder="Enter SKU" value="{{$product->sku}}">
                                @error('sku')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="position-relative mb-3">
                                ...
                                <input readonly type="text" name="barcode" id="barcode" class="form-control" placeholder="Enter Barcode" value="{{$product->barcode}}">
                                @error('barcode')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="position-relative mb-3">
                                ...
                                <input readonly type="text" name="origin" id="origin" class="form-control" placeholder="Enter Origin" value="{{$product->origin}}">
                                @error('origin')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
            ...
            <div class="row">
                @for($i=1; $i<=8; $i++) <div class="col-md-3 border border-1">
                    <div class="position-relative mb-3">
                        ...
                        switch($i){
                        case 1:
                        $label = 'Product Front Image (Variant 1)';
                        break;
                        case 2:
                        ...
                        break;
                        case 4:
                        $label = 'FASSAI No. Image';
                        break;
                        case 5:
                        $label = 'Ingrident Details';
                        break;
                        default:
                        $label = 'Produt Image';
                        break;
                        ...
                        <div id="product-image-view-{{$i}}">
                            ...
                            <button disabled type="button" class="btn btn-link cross-icon" onclick="removeImage('product-image-view-{{$i}}', {{$productImages[$i-1]->id}})"><i class="fa fa-2x fa-times"></i></button><img class="mx-5 my-3 img-thumbnail border-0" src="{{(env('APP_ENV') == "production" ? url('/public/images/products/' . $productImages[$i-1]->image) : url('/images/products/' . $productImages[$i-1]->image))}}" width="200" height="200">
                            @endif
                        </div>
                        <input disabled style="display:none" type="file" name="product_image[{{$i}}]" id="product_image_{{$i}}" class="form-control" onchange="displayImage(this, 'product-image-view-{{$i}}');" />
                    </div>
            </div>
            @endfor
        </div>
                ...
                @for($i=1; $i<=4; $i++) @php $video_link=json_decode($product->video_url, true)
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="input-group">
                            ...
                            <input readonly type="text" class="form-control" name="video_link[]" id="video_link_{{$i}}" value="{{$video_link != false && !is_null($video_link) ? $video_link[$i-1] : ""}}">
                        </div>
                    </div>
                    @endfor
            </div>
        ...
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="position-relative mb-3">
                                ...
                                <input readonly type="text" class="form-control" name="selling_price" id="selling_price" placeholder="Enter Selling Price" value="{{$product->product_mrp}}" />
                                @error('selling_price')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="position-relative mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    @endphp
                                    <input readonly type="text" class="form-control" name="discount_price" id="discount_price" placeholder="Discount" value="{{round($discount_rate)}}" />
                                    <div class="input-group-text">
                                        <span class="">%</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="position-relative mb-3">
                                ...
                                <input readonly type="text" class="form-control" name="net_price" id="net_price" value="{{$product->net_price}}" readonly placeholder="Enter Net Price" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="position-relative mb-3">
                                        ...
                                        <input readonly type="text" class="form-control" name="minoq" id="minoq" value="{{$product->minoq}}" placeholder="Enter Min Order Quantity" />
                                        @error('minoq')
                                        <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="position-relative mb-3">
                                        ...
                                        <input readonly type="text" class="form-control" name="maxoq" id="maxoq" value="{{$product->maxoq}}" placeholder="Enter Max Order Quantity" />
                                        @error('maxoq')
                                        <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="position-relative mb-3">
                                        ...
                                        <input readonly type="text" class="form-control" name="cost" id="cost" value="{{$product->cost}}" placeholder="Enter COST" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-3 pt-4">
                    <div class="form-check form-check-inline">
                        <input disabled class="form-check-input" type="checkbox" value="1" id="taxable" name="taxable" {{$product->taxable == 1 ? " checked='checked'" : ""}}>
                ...
                <div class="col-md-3">
                    <div class="position-relative mb-3">
                        ...
                        <div class="input-group">
                            <input readonly type="text" class="form-control" name="taxable_rate" id="taxable_rate" value="{{$product->tax_rate}}" {{$product->taxable != 1 ? " readonly='readonly'" : ""}} />
                            <div class="input-group-text">
                                <span class="">%</span>
                            </div>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="position-relative mb-3">
                        ...
                        <input readonly type="text" class="form-control" name="taxable_amount" id="taxable_amount" value="{{$product->tax_amount}}" readonly />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="position-relative mb-3">
                        <label for="net_price_without_tax" class="form-label">Net Price Without Tax</label>
                        <input readonly type="text" class="form-control" name="net_price_without_tax" id="net_price_without_tax" value="{{$product->net_price_with_tax}}" readonly />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="my-3 border p-4" id="varient_property_manual_div">
                ...
                <div class="row mb-1">
                    <div class="col-sm-3">
                        <div class="form-check">
                            <input disabled class="form-check-input" @if($map['checked']==1) checked @endif type="checkbox" value="{{$varient_id}}" name="variant_id[]" id="variant_id_{{$varient_id}}" data-text="{{$map['name']}}">
                ...
                @endforeach
                <button class="btn btn-danger" disabled type="button" id="generate-variant-tbl-btn">Generate Variant Table</button>
            </div>
...
_productpriceid" value="{{$variant->id}}" />
                        <tr>
                            <th nowrap><input readonly class='readonly-as-label' type='text' name='@if(!is_null($variant->variant_value_id_1))variant[{{$variant->variant_value_id_1}}]@endif
@if(!is_null($variant->variant_value_id_2))[{{$variant->variant_value_id_2}}]@endif
@if(!is_null($variant->variant_value_id_3))[{{$variant->variant_value_id_3}}]@endif
...
@if(!is_null($variant->Object3Value))/ {{$variant->Object3Value}}@endif" readonly /></th>
                            <td><input readonly class='form-control' type='text' name='@if(!is_null($variant->variant_value_id_1))variant[{{$variant->variant_value_id_1}}]@endif
@if(!is_null($variant->variant_value_id_2))[{{$variant->variant_value_id_2}}]@endif
@if(!is_null($variant->variant_value_id_3))[{{$variant->variant_value_id_3}}]@endif
...
_product_mrp' value="{{$variant->product_mrp}}"></td>
                            <td>
                                ...
                                @endphp
                                <div class='input-group'><input readonly class='form-control' type='text' name='@if(!is_null($variant->variant_value_id_1))variant[{{$variant->variant_value_id_1}}]@endif
@if(!is_null($variant->variant_value_id_2))[{{$variant->variant_value_id_2}}]@endif
@if(!is_null($variant->variant_value_id_3))[{{$variant->variant_value_id_3}}]@endif
...
_quantity' value="{{$variant->quantity}}"></td>
                            <td class='text-center'>
                                <div class='position-relative form-check'><label class='form-label form-check-label'><input readonly name='variant_default' @if($variant->mark_as_default == 1) checked @endif value='{{$variant->id}}' type='radio' class='form-check-input' id='@if(!is_null($variant->variant_value_id_1))variant_{{$variant->variant_value_id_1}}@endif
                                        @if(!is_null($variant->variant_value_id_2))_{{$variant->variant_value_id_2}}@endif
                                        @if(!is_null($variant->variant_value_id_3))_{{$variant->variant_value_id_3}}@endif
                                        _default' /></label></div>
                            </td>
...
_image-view">
                                    ...
                                    <button disabled type="button" class="btn btn-link" onclick="removeImage('@if(!is_null($variant->variant_value_id_1))variant_{{$variant->variant_value_id_1}}@endif
@if(!is_null($variant->variant_value_id_2))_{{$variant->variant_value_id_2}}@endif
@if(!is_null($variant->variant_value_id_3))_{{$variant->variant_value_id_3}}@endif
